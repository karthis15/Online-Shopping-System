...
public class UserController {
	...
	@GetMapping("/addCart")
	public String addToCart(@RequestParam Long pid, @RequestParam String uid, HttpSession session) {
	...
	public String myOrder(Model m, Principal p) {
		...
		List<Order> orders = orderService.getOrdersByUser(loginUser.getId());
